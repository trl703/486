...
## -----------------------------------------------------------------------------------
getwd() ###figuring out working directory
...
## -----------------------------------------------------------------------------------
d <- readr::read_csv("ToothGrowth.csv") ## lets you know what the delimiter, variables, and variable types
...
## -----------------------------------------------------------------------------------
left_join(ToothGrowth, suppTranslation, by = "supp") ###Adding on
...
b <- readRDS("a.RDS")
b
saveRDS(toothgrowth, file = "a.RDS")
